...
void main() {
  group('UserIdChangedEventListener', () {
    ...
    testWidgets(
      'adds UserIdChangedEvent to analyticsBloc when user changes '
      ...
      (tester) async {
        ...
        await tester.pumpApp(
          ...
          listener: UserIdChangedEventListener(),
        );

        verify(
          () => analyticsBloc.add(UserIdChangedEvent(user.id)),
        ).called(1);
      },
    );
  });
